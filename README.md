...
- [hifriendbot/cogmemai-mcp](https://github.com/hifriendbot/cogmemai-mcp) 📇 ☁️ 🍎 🪟 🐧 - Persistent cloud memory for AI coding assistants with 33 tools, semantic search, auto-skills, and knowledge graph. Zero-install remote endpoint or npm install.
